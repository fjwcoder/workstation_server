...
class FileClean extends AdminBase
{
    ...
    public function getFileClearList()
    {
        ...
        $picture_list = $this->getFileShowList($this->modelObPicture, $list, 'picture_list');
        
        $file_list = $this->getFileShowList($this->modelObFile, $list, 'file_list');
    ...
    public function fileClearDbByType($type = 'picture')
    {
        ...
        $model = $type == 'picture' ? $this->modelObPicture : $this->modelObFile;

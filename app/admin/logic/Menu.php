...
class Menu extends AdminBase
{
    ...
    public function getMenuList($where = [], $field = true, $order = '', $paginate = false)
    {
        ...
        return $this->modelAdminMenu->getList($where, $field, $order, $paginate);
    }
    ...
    public function getMenuInfo($where = [], $field = true)
    {
        ...
        return $this->modelAdminMenu->getInfo($where, $field);
    }
    ...
    public function menuAdd($data = [])
    {
        ...
        $validate_result = $this->validateAdminMenu->scene('add')->check($data);
        
        if (!$validate_result) {
            
            return [RESULT_ERROR, $this->validateAdminMenu->getError()];
        }
        ...
        return $result ? [RESULT_SUCCESS, '菜单添加成功', $url] : [RESULT_ERROR, $this->modelAdminMenu->getError()];
    }
    ...
    public function menuEdit($data = [])
    {
        ...
        $validate_result = $this->validateAdminMenu->scene('edit')->check($data);
        ...
        return $result ? [RESULT_SUCCESS, '菜单编辑成功', $url] : [RESULT_ERROR, $this->modelAdminMenu->getError()];
    }
    ...
    public function menuDel($where = [])
    {
        ...
        $result = $this->modelAdminMenu->deleteInfo($where);
        
        $result && action_log('删除', '删除菜单，where：' . http_build_query($where));
        
        return $result ? [RESULT_SUCCESS, '菜单删除成功'] : [RESULT_ERROR, $this->modelAdminMenu->getError()];
    }
    ...
    public function getDefaultTitle()
    {
        ...
        return $this->modelAdminMenu->getValue(['module' => MODULE_NAME, 'url' => URL], 'name');
    }
}
